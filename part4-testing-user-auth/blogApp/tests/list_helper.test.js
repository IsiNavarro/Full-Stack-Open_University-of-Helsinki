...
describe('favoriteBlog', () => {
    test('favorite of empty list is null', () => {
    ...
    test('many blogs works', () => {
        assert.strictEqual(listHelper.favoriteBlog(blogs), blogs.find(blog => blog.likes === 12))
    })
})
...
describe('mostBlogs', () => {
	...
	test('one blog returns the author of the blog and number 1', () => {
