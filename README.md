...
| Part | Topic | Status | Live Demo |
|---|---|---|---|
| [Part 0](./part0-web-fundamentals) | Fundamentals of Web Apps | Complete | — |
| [Part 1](./part1-intro-to-react) | Introduction to React | Complete | — |
...
Full Stack Open is a free, university-accredited programme widely regarded as one of the best fullstack developer education resources in Europe. All exercises are completed individually with no pre-written solution code.